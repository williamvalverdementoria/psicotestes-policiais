    ...
    <div className="min-h-screen bg-gradient-to-br from-primary via-primary to-primary-dark flex items-center justify-center px-4">
      ...
      <div className="w-full max-w-md relative">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-extrabold text-white mb-2">Crie sua conta grátis</h1>
          <p className="text-gray-400 text-sm">Comece a treinar para o psicotécnico agora</p>
        </div>
        ...
        <div className="glass-card rounded-2xl p-8 bg-white shadow-2xl shadow-black/10">
          <form onSubmit={handleSubmit} className="space-y-5">
            <div>
              ...
              <div className="relative">
                ...
                <input type="text" value={nome} onChange={e => setNome(e.target.value)} className="input-modern pl-11" placeholder="Seu nome" required />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input type="email" value={email} onChange={e => setEmail(e.target.value)} className="input-modern pl-11" placeholder="seu@email.com" required />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input type={showPassword ? 'text' : 'password'} value={password} onChange={e => setPassword(e.target.value)} className="input-modern pl-11 pr-12" placeholder="Mínimo 6 caracteres" required />
            ...
            <div>
              ...
              <div className="relative">
                <Lock className="absolute left-3.5 top-1/2 -translate-y-1/2 w-4.5 h-4.5 text-gray-400" />
                <input type={showPassword ? 'text' : 'password'} value={confirmPassword} onChange={e => setConfirmPassword(e.target.value)} className="input-modern pl-11" placeholder="Repita a senha" required />
              </div>
            </div>
          ...
          <p className="text-center text-sm text-gray-500 mt-7">
            Já tem conta?{' '}
            <Link to="/login" className="text-accent font-bold hover:underline">Entrar</Link>
          </p>
        </div>
      </div>
    </div>
